    ...
    <div className="min-h-screen bg-brand-bg flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-10">
        <div className="w-full max-w-lg space-y-7">
          ...
          >
            ...
            {file ? (
              ...
              <div className="text-center">
                ...
                <p className="text-[10px] text-brand-muted font-barlow mt-1">{ACCEPTED_LABEL}, up to {MAX_MB}MB</p>
              </div>
            )}
          </div>
          ...
          >
            {uploading ? "Uploading…" : file ? "Upload File → Review Before Activation" : "Select a File to Continue"}
          </button>
